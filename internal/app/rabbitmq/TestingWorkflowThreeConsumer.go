...
type TestingWorkflowThreeConsumer struct {
...
func (c *TestingWorkflowThreeConsumer) Consume(payload interface{}) (interface{}, error) {
	c.mutex.Lock()
...
func (c *TestingWorkflowThreeConsumer) Response(payload interface{}, data ...interface{}) interface{} {
	if c.form == nil {
		c.form = &form2.TestingForm{}
		err := c.form.AsyncWorkflowParse(payload)
		if err != nil {
