...
type TestingWorkflowConsumer struct {
...
func (c *TestingWorkflowConsumer) Consume(payload interface{}) (interface{}, error) {
	c.mutex.Lock()
...
func (c *TestingWorkflowConsumer) Response(payload interface{}, data ...interface{}) interface{} {
	if c.form == nil {
		c.form = &form2.TestingForm{}
		err := c.form.AsyncWorkflowParse(payload)
		if err != nil {
...
func (c *TestingWorkflowConsumer) ForwardPayload() []xtremerabbitmq.AsyncWorkflowForwardPayloadResult {
