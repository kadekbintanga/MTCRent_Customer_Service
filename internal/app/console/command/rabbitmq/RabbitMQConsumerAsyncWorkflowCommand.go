	...
	xtremerabbitmq.ConsumeWorkflow([]xtremerabbitmq.AsyncWorkflowConsumeOpt{
		{
			...
			Consumer: &rabbitmq.TestingWorkflowConsumer{},
		},
		{
			Queue:    "service.customer.convert.async-workflow-2",
			Consumer: &rabbitmq.TestingWorkflowTwoConsumer{},
		},
		{
			Queue:    "service.customer.convert.async-workflow-3",
			Consumer: &rabbitmq.TestingWorkflowThreeConsumer{},
		},
		{
			Queue:    "service.customer.convert.async-workflow-4",
			Consumer: &rabbitmq.TestingWorkflowFourConsumer{},
		},
	})
}
