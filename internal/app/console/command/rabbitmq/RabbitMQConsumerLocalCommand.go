...
type RabbitMQConsumerLocalCommand struct{}

func (class *RabbitMQConsumerLocalCommand) Command(cobraCmd *cobra.Command) {
...
func (class *RabbitMQConsumerLocalCommand) Handle() {
